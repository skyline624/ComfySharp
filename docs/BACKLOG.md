...
| 11 | Base native C#/XAML, PreviewAny texte sans persistance des sorties et StringFormat au profil texte partiel avec ports fixes | Formatage Python complet de StringFormat, croissance dynamique des ports, PreviewAny Markdown et représentations restantes, widgets/outils locaux avancés, SDK et qualification UI |
