...
| 4 | JSON préservé, compilation conservatrice, éditions et canvas initial ; import graphique PNG et reconstruction des prompts API JSON/PNG ; conversion signalée des nombres non finis et repli PNG vers prompt | Compilation complète, sous-graphes, bypass, reroutes, copier/coller, onglets/brouillons et fidélité exhaustive ; disposition/callbacks/remplacements de l'import API et A1111 |
