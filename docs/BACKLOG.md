...
| 6 | Dix dtypes safetensors CPU, inspection/hash, bruit natif, étape Euler, cinq générateurs et six traitements SIGMAS intégrés au Host ; tokenisation/encodeurs CLIP ; graphes U-Net SD1/SD2 et VAE classique CPU/F32, chargement strict, sigma/EPS/V et CFG ; trajectoire Euler guidée sans churn avec huit références réduites, comparées sur Windows local | Qualification numérique multiplateforme et dimensions complètes, vrais poids et assemblage génératif ; autres schedulers/samplers, formats historiques sûrs, détection, textual inversion, autres encodeurs/tokeniseurs, adapters et GPU |
