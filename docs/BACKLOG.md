...
| 9 | Objectif/datasets/RNG, optimisateurs/pertes Float32, initialisation des 686 cibles SD ordinaires, différences norm/biais et alpha entraînable ; gradients CUDA sur 1250 paramètres avec pont natif de générateur ; persistance des 686 cibles mixtes et rechargement CPU réel vérifiés | Import pour reprendre un entraînement existant, images réelles, conditioning complet, nœuds/LORA_MODEL, autres algorithmes/dtypes, checkpointing/offload, précision Linux/macOS et qualification complète |
