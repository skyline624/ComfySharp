...
| 4 | JSON préservé, compilation conservatrice, éditions et canvas initial ; imports PNG/API/JSON Python ; modes muet et bypass du graphe statique ; duplication de nœuds avec liens internes et entrées externes optionnelles ; commandes et undo/redo | Compilation complète, sous-graphes/nœuds virtuels et leurs modes, groupes/reroutes et leur duplication, copier/coller, onglets/brouillons et fidélité exhaustive ; disposition/callbacks/remplacements de l'import API et A1111 |
