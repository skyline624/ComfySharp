...
| 7 | EmptyImage, ImageInvert, RepeatImageBatch et ImageFromBatch sur CPU/F32 RGB/RGBA, avec graphe réel et aperçu texte ; aucune famille de modèles annoncée compatible | ImageBatch avec crop/resize complet, codecs/chargement/sauvegarde, autres traitements image, domaines dtype/device, chaque famille/variante image avec vrais poids |
