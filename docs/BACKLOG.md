...
| 4 | JSON préservé, compilation conservatrice, éditions et canvas initial ; import graphique PNG et reconstruction des prompts API JSON/PNG en documents éditables | Compilation complète, sous-graphes, bypass, reroutes, copier/coller, onglets/brouillons et fidélité exhaustive ; nombres non finis, disposition/callbacks/remplacements de l'import API |
