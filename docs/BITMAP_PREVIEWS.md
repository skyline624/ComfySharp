...
Ces tests de primitives ne valident pas de génération avec poids préentraînés. La nouvelle interface bitmap reste à vérifier sur Linux/macOS et dans les distributions autonomes. La [CI précédente](qualification/image-file-nodes-ci-8556ab2.md) couvre les nœuds fichiers sur les trois systèmes, sans cette nouvelle interface ; ses gates numériques SD/CLIP restent ouvertes.
