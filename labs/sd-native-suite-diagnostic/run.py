...
def verify_trx(directory, expected_ids, exit_code):
    ...
    for info in summary.findall('.//t:RunInfo',ns):
        ...
        notifications += 1
    return {'verified':True,'exitCode':exit_code,'passed':passed,'failed':failed,
...
def main():
    ...
    try:
        ...
        return 1
    clear = {'COMFYSHARP_SD_NATIVE_SUITE_TRACE_DIR','ATEN_CPU_CAPABILITY','COMFYSHARP_SD_UNET_FINE_TRACE_DIR','COMFYSHARP_SD_UNET_TRACE_DIR',
    ...
    for mode in MODES:
        for origin in ('source',*ORIGINS):
            ...
            if origin == 'source':
                ...
                env['COMFYSHARP_SD_NATIVE_SUITE_TRACE_DIR'] = str(directory/'traces')
