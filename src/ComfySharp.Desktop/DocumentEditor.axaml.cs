...
internal static class NodeTemplates
{
    public static JsonObject Create(string type)
    {
        ...
        switch (type)
        {
            ...
            case "VAEEncode": In("pixels", "IMAGE"); In("vae", "VAE"); Out("LATENT", "LATENT"); break;
            case "LoadImage": widgets = new("select-image.png"); In("image", "COMBO"); Out("IMAGE", "IMAGE"); Out("MASK", "MASK"); break;
